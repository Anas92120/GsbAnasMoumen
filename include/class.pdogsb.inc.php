 ...
 * @param $idFrais 
*/
	public function supprimerFraisHorsForfait($fraisSup){
		$req = "delete from lignefraishorsforfait where lignefraishorsforfait.id =$fraisSup ";
		PdoGsb::$monPdo->exec($req);
	}
/**
 ...
 */
	...
	public function majEtatFicheFrais($idVisiteur,$mois,$etat){
		$req1 = "update ficheFrais set idEtat = '$etat', dateModif = now() 
		where fichefrais.idvisiteur ='$idVisiteur' and fichefrais.mois = '$mois'";
	...
	public function PDFVisiteur($visiteur){
		...
		$req = "SELECT lignefraisforfait.quantite AS quantite, fraisforfait.libelle AS libelle 
